...
with tab1:
    ...
    with col_res:
        ...
        ol  = " ⚠ OVER TROPICAL DRAFT" if res["over_draft"] else ""
        ...
        summary_df([
            ...
            ("Tropical Draft",        f"{res['draft_max_m']} m"),
...
with tab2:
    ...
    with col_d1:
        draft_inp = st.number_input(
            ...
            step=0.01, format="%.3f",
            help="Tide-adjusted permissible draft. Must be ≤ vessel tropical draft.",
        )
    ...
    with col_d2:
        ...
        summary_df([
            ...
            ("Seawater Density",      f"{SEAWATER_DENSITY_NG} t/m³  🔒 Nigerian waters"),
            ("Tropical Draft",        f"{res2['draft_max_m']} m"),
            ("Breakwater Depth",      f"{water_depth:.2f} m"),
...
with tab4:
    ...
    with st.form("add_vessel_form"):
        ...
        with c3:
            new_draft = st.number_input("Tropical Draft (m) *", 2.0, 25.0, 9.0, 0.1)
...
with tab5:
    ...
    with edit_col:
        ...
        with st.form(f"edit_form_{sel_vessel}"):
            ...
            with ec3:
                e_draft = st.number_input("Tropical Draft (m)", 2.0, 25.0,
