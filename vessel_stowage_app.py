...
_BASE_VESSELS: list[dict] = [
    ...
    {"name":"Alkebulan","class":"Suezmax",
     ...
     "breakwater_lat":11.3,"api_ref":19,"note":"Suezmax mother vessel — BIA only"},
    ...
    {"name":"Bryanston","class":"Aframax",
     ...
     "breakwater_lat":11.35,"api_ref":27,"note":"Aframax mother vessel — BIA only"},
    # ── LR-1 ─────────────────────────────────────────────────────────────────
    {"name":"MT San Barth","class":"LR-1",
     ...
     "breakwater_lat":3.45,"api_ref":27,"note":"Permanent BIA intermediate storage; breakwater LAT 3.45 m"},
    ...
    {"name":"MT Westmore","class":"MR",
     ...
     "breakwater_lat":3.45,"api_ref":20,"note":"Westmore storage — dredge depth 7 m"},
    {"name":"MT Chapel","class":"MR",
     ...
     "breakwater_lat":14.0,"api_ref":20,"note":"Chapel storage — deep water terminal"},
    {"name":"MT Jasmine S","class":"MR",
     ...
     "breakwater_lat":3.45,"api_ref":20,"note":"Jasmine S storage"},
    {"name":"MT Laphroaig","class":"MR",
     ...
     "breakwater_lat":3.45,"api_ref":20.5,"note":"Shuttle — Chapel/JasmineS; dredge depth 2.55 m"},
    {"name":"MT Pinarello","class":"MR",
     ...
     "breakwater_lat":3.45,"api_ref":20,"note":"Shuttle — Chapel/JasmineS; dredge depth 2.55 m"},
    {"name":"MT Sherlock","class":"MR",
     ...
     "breakwater_lat":3.45,"api_ref":20,"note":"Shuttle — Jasmine S primary; dredge depth 2.55 m"},
    ...
    {"name":"MT Bedford","class":"General Purpose",
     ...
     "breakwater_lat":3.45,"api_ref":20,"note":"Ibom offshore loader; dredge depth 2.55 m"},
    {"name":"MT Bagshot","class":"General Purpose",
     ...
     "breakwater_lat":3.45,"api_ref":20,"note":"Shuttle — Barge Starturn; dredge depth 2.55 m"},
    {"name":"MT Woodstock","class":"General Purpose",
     ...
     "breakwater_lat":3.45,"api_ref":20,"note":"Shuttle — Duke (Awoba); dredge depth 2.55 m"},
    {"name":"MT Rathbone","class":"General Purpose",
     ...
     "breakwater_lat":3.45,"api_ref":20,"note":"Shuttle — Ibom/Balham; dredge depth 2.55 m"},
    ...
    {"name":"MT Santa Monica","class":"General Purpose",
     ...
     "breakwater_lat":3.45,"api_ref":23,"note":"Multi-field shuttle; avg API 23\u00b0"},
    {"name":"Duke","class":"General Purpose",
     ...
     "breakwater_lat":3.45,"api_ref":41.2,"note":"Duke storage barge \u2014 Point D (Awoba)"},
]
